...
- `dp.apply_changes()` tracks insert/update/delete operations
...
### Monitoring & Alerting
- **SDP event log** — built-in audit trail of pipeline executions and quality metrics
...
- Monitor with scheduled SQL queries against the SDP event log
...
4. The SDP event log is your built-in observability layer
